...
app = cdk.App()
mystack = CdkStack(app, "dev-meta-upload-stack",
        description="Meta Business Marketing Platform Uploader AWS CDK stack (SO9074): The CDK stack deploys resources on customer AWS account that enables them to upload audiences on Meta Business Marketing Platform.",
        env=dev_env
        )
cdk.Tags.of(mystack).add("project", "cleanroom-meta-upload")
