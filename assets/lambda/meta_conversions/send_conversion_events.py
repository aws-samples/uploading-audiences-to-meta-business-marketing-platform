...
class MetaAWSAMTConnector:
    ...
    def send_conversion_data(self, chunk_id: int, df_chunk):
        """
...
def load_config(ssm_parameter_path):
    ...
    """
    #TODO unable to use customer KMS key. Permission issues.Workaround use AWS/SSM key.
...
def get_sample_event():
    ...
    payload = {
        ...
        "region": "us-west-2",
        "resources": [
            "arn:aws:s3:::cleanroom-meta-activations-target-bucket"
        ],
        "detail": {
            "version": "0",
            "bucket": {
            "name": "cleanroom-meta-activations-target-bucket"
            },
            "object": {
            "key": "customer_target/run-S3bucket_node3-1-part-r-00000",
            "size": 99797,
